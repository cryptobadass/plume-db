...
// DefaultConfigTemplate defines the configuration template for the plumeDB configuration
const DefaultConfigTemplate = `
#############################################################################
###                             PlumeDB Configuration                     ###
#############################################################################

[state-commit]
# Enable defines if the PlumeDB should be enabled to override existing IAVL db backend.
...
# This config only take effect when PlumeDB is enabled (sc-enable = true)
