...
import (
	...
	errorutils "github.com/plume-protocol/plume-db/common/errors"
	"github.com/plume-protocol/plume-db/common/logger"
	"github.com/plume-protocol/plume-db/common/utils"
	"github.com/plume-protocol/plume-db/config"
	"github.com/plume-protocol/plume-db/proto"
	"github.com/plume-protocol/plume-db/ss/types"
	"github.com/plume-protocol/plume-db/stream/changelog"
		...
		for entry := range ch {
			...
			if counter%ImportCommitBatchSize == 0 {
				...
				if counter%1000000 == 0 {
					...
					metrics.IncrCounterWithLabels([]string{"plume", "migration", "nodes_imported"}, float32(1000000), []metrics.Label{
